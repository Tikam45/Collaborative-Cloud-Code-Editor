...
export default function New({socket, type, stopEditing, addNew}: {
    socket : Socket
    type: "file" | "folder",
    stopEditing: () => void
    ...
    return(
        <div  className="w-full flex items-center h-7 px-1 hover:bg-secondary rounded-sm transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring cursor-pointer">
            ...
            <form
                ...
                <input 
                    className={`bg-transparent w-full rounded-sm outline-foreground transition-all focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-background focus-visible:ring-2 focus-visible:ring-ring`}
                    ref={inputRef}
                    onBlur={() => createNew()}
                />
            </form>
